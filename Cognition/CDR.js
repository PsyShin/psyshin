...
function SubmitBtn(){
	...
	for(let i=0; i<6; i++) for(let j=1; j<6; j++) if(ShowTable[i].cells[j]) ShowTable[i].cells[j].style.backgroundColor = "#FFF";
	document.getElementById("CA2").style.backgroundColor = "#FFF";
	document.getElementById("CA2").style.backgroundColor = "#FFF";
	// get raw data
