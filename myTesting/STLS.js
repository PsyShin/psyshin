...
//	resultText.style = "background-color: #fff; width = 80%; padding: 20px;";
	...
	if(ScaleScores[0] > 111){
		if(ScaleScores[1]){
			if(ScaleScores[2]){var myType = AllTypesEx[0];}else{var myType = AllTypesEx[3];}
		}else{
			if(ScaleScores[2]){var myType = AllTypesEx[2];}else{var myType = AllTypesEx[6];}
		}
	}else{
		if(ScaleScores[1]){
			if(ScaleScores[2]){var myType = AllTypesEx[1];}else{var myType = AllTypesEx[5];}
		}else{
			if(ScaleScores[2]){var myType = AllTypesEx[4];}else{var myType = AllTypesEx[7];}
		}
	}
