...
function SubmitBtn(){
	...
	MeanScores = [null,null,null,null];
	for(let i=0; i<20; i++){
	...
	for(let i=0; i<4; i++) MeanScores[i] = (ScaleScores[i+1]/FacWei[i]).toFixed(2);
	...
	new Chart(radarChart,{
		data: {
			labels: ['Delay', 'Poor Time Management', 'Until Deadline', 'Slow'],
			datasets: [{
				type: 'bar',
				label: '受測者各向度平均',
				data: MeanScores,
